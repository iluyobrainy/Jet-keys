...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { icon: Plane, label: "Jet Requests", href: "/jet-requests" },
    { icon: MapPin, label: "Locations", href: "/locations" },
    { icon: MapPin, label: "Location Pricing", href: "/location-pricing" },
    { icon: Calendar, label: "Bookings", href: "/bookings" },
    { icon: Calendar, label: "Quote Requests", href: "/quote-requests" },
