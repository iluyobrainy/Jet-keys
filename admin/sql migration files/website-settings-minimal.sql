-- Minimal website settings migration - only essential columns
-- This should definitely work as it only uses key and value

-- Clear existing data
DELETE FROM website_settings;

-- Insert data with only key and value columns
